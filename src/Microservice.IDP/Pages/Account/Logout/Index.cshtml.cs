...
namespace Microservice.IDP.Pages.Logout;
...
public class Index : PageModel
{
    ...
    public Index(IIdentityServerInteractionService interaction, IEventService events, SignInManager<User> signInMamager)
    {
